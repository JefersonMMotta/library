...
<form method="post" action="{{url('clientes/update/'.$cliente->id)}}" class="row g-3">
    @csrf
    <div class="col-md-4">
     ...
     <div class="col-md-2">
        ...
        <input type="text" class="form-control" name="data_nascimento" id="data_nascimento" name="data_nascimento" value="{{$cliente->data_nascimento}}">
    </div>
    <div class="col-md-3">
